								...
								<nav class="header-nav-top">
									<ul class="nav nav-pills">
										...
										<li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show">
											...
											<a class="nav-link ps-0" href="#"><i class="fas fa-angle-right"></i> Home</a>
										</li>
										<li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show">
										...
										<li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show">
											<a class="nav-link ps-0" href="#"><i class="fas fa-phone"></i>Logout</a>
										</li>
								...
								<div class="header-nav pt-1">
									<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1">
										<div class="InputContainer">
											<input type="text" name="text" class="input" id="input" placeholder="Search For Products,Updates">
